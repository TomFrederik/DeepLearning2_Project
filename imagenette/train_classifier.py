...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if not args.resume:
        ...
        model_path = join('.', 'imagenette', 'experiments',
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        acc1_real = metrics['acc1/1_real']
        is_best = acc1_real > best_acc1_real
        best_acc1_real = max(acc1_real, best_acc1_real)
...
def validate_imagenette(val_loader, model, args):
    batch_time = AverageMeter('Time', ':6.3f')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', default='data/imagenette2', 
